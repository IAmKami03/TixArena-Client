          ...
          <div className="flex flex-col sm:flex-row gap-[14px] sm:gap-5">
            <div className="w-full sm:w-[262px]">
              <input
                ...
                className={`w-full h-[62px] rounded-[30px] border-2 bg-[#191919] px-4.5 py-5 text-[#ABABAB] font-[Manrope] font-medium text-[16px] leading-[140%] tracking-[-0.01em] outline-none ${
                  fieldErrors.firstName ? "border-[#FF7466]" : "border-[#262525]"
                }`}
              />
            ...
            <div className="w-full sm:w-[262px]">
              <input
                ...
                className={`w-full h-[62px] rounded-[30px] border-2 bg-[#191919] px-4.5 py-5 text-[#ABABAB] font-[Manrope] font-medium text-[16px] leading-[140%] tracking-[-0.01em] outline-none ${
                  fieldErrors.lastName ? "border-[#FF7466]" : "border-[#262525]"
                }`}
              />
