  ...
  return (
    <div className="flex justify-center mt-7 px-4 sm:px-6 lg:px-0">
      <div className="w-full max-w-[1020px] border-0">
       <div className="mb-7"> <h2 className="text-[26px] sm:text-[38px] lg:text-[60px] leading-[1.15] lg:leading-[normal] text-start text-[#FFFFFF] font-Instrument Serif font-normal">
          Top Event
        </h2>
        <div className="flex flex-col sm:flex-row sm:justify-between gap-4 sm:gap-0">
          <p className="text-[#CECECE] text-[14px] sm:text-[16px] font-inter font-normal">
            Discover the hottest events people are talking about <br className="hidden sm:block" /> and
        ...
        <div className="flex gap-4 overflow-x-auto pb-2 scrollbar-hide lg:hidden snap-x snap-mandatory -mx-4 px-4 sm:-mx-6 sm:px-6">
          {events.map((event) => (
            <div key={event._id} className="w-[260px] sm:w-[300px] shrink-0 snap-start">
              <EventCard
                id={event._id}
